...
/**
 * 게시된 스팟 기록을 filter 로 필터링해 최신순으로 조회한다. ALL=전체, INTEREST=관심 꽃(사용자 관심 카테고리와 겹치는 식물이 태깅된 기록), FOLLOWING=팔로잉 중인 사용자의 기록. 비로그인은 ALL만 조회할 수 있으며 INTEREST/FOLLOWING은 로그인 필요(401). 내 반응은 빈 목록이다. 각 기록에는 대표 사진 coverPhoto와 sortOrder 오름차순의 전체 사진 목록 photos가 포함된다.
 * @summary 피드 조회
 */
